...
export default function SearchResultTable({ data }: SearchResultTableProps) {
  return (
    <div className="mt-6 mb-8 rounded-2xl border border-darkMain/20 bg-darkMain/5">
      {/* Table */}
      <Table>
        <TableHeader>
          <TableRow className="bg-darkMain h-14">
        ...
        <TableBody>
          {data.map((item, index) => (
            ...
            >
              ...
              {/* Result Type */}
              <TableCell className="font-medium">
                <span className="block min-w-[91px] px-2 py-1 text-center text-xs font-semibold text-darkMain bg-greenMain rounded-full">
                  Social Media
                </span>
              </TableCell>
              ...
              {/* Time Estimate */}
              <TableCell className="font-medium">
                <span className="block min-w-[91px] px-2 py-1 text-center text-xs font-semibold text-white bg-darkMain rounded-full">
                  6 Days
                </span>
              </TableCell>
            </TableRow>
      ...
      <div className="flex justify-end py-3">
        <Button
          variant="link"
          className="flex items-center gap-2 text-darkMain font-bold hover:underline"
        >
