  ...
  return (
    <div className="flex gap-6 justify-between mb-6 items-center">
      ...
      <Button variant="link" type="button" className={'no-underline p-0'}>
        {notifications > 0 ? (
          <div className="relative text-darkMain">
            <div className="absolute -right-1 -top-1 min-w-[18px] rounded-full min-h-[18px] text-white bg-orangeMain text-xs font-normal">
              {notifications}
            </div>
