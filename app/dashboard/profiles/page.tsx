...
import { getProfiles, getUser, getUserDetails } from '@/utils/supabase/queries'
...
export default async function Dashboard() {
  ...
  const [user, userDetails, profiles] = await Promise.all([
    getUser(supabase),
  ...
  const removalActivated = false

  return (
    <section className="mb-16 bg-white">
      <Title
        title="Manage Your Profiles"
        subtitle="Submit your profile or that of a family member to begin a free analytics and protect your privacy. You can submit up to 10 profiles."
      />
